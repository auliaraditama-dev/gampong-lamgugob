...
<head>
<meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1,viewport-fit=cover"><meta name="theme-color" content="#2d735b"><meta name="color-scheme" content="light dark">
...
<script src="assets/js/icons.js?v=20260920.5"></script><script>const b=document.getElementById('articleTheme');function syncArticleTheme(){if(!b)return;const dark=document.documentElement.dataset.theme==='dark';b.innerHTML=`<i data-lucide="${dark?'sun':'moon'}"></i>`;if(window.lucide)window.lucide.createIcons()}if(b)b.addEventListener('click',()=>{const n=document.documentElement.dataset.theme==='dark'?'light':'dark';document.documentElement.dataset.theme=n;localStorage.setItem('gampong-theme',n);syncArticleTheme()});syncArticleTheme();</script>
</body></html>
