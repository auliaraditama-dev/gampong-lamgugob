...
echo json_encode([
'name'=>$name,'short_name'=>(function_exists('mb_substr')?mb_substr($short,0,24):substr($short,0,24)),'start_url'=>'./','scope'=>'./','display'=>'standalone','background_color'=>'#f5f7f5','theme_color'=>'#2d735b','lang'=>'id','dir'=>'ltr','description'=>trim((string)($settings['seo_description']??''))?:('Portal informasi dan layanan '.$name.'.'),
